...
var TestAsyncSleepProcessor = (function (_super) {
    __extends(TestAsyncSleepProcessor, _super);
    function TestAsyncSleepProcessor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TestAsyncSleepProcessor.prototype.fx = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.runAsync(timeout)];
                    case 1:
                        _a.sent();
                        return [2, resolve({
                                successful: true
    ...
    return TestAsyncSleepProcessor;
}(BaseProcessor));
export { TestAsyncSleepProcessor };
